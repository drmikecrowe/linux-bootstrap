...
# Version:      1.0.11
# Date (UTC):   Mon, 19 Jul 2021 22:40:47 +0000
# Generated by: bashing 0.2.2
# ---------------------------------------------
export __BASHING_VERSION='0.2.2'
export __VERSION='1.0.11'
...
function __run() {
  ...
  case "$cmd" in
    ...
    apt_search            :  Install apt_search
    awscli                :  Install awscli
    basher                :  Install basher
    bashew                :  Install bashew
...
HELP
      ...
      ;;
    "version")
      echo "bootstrap 1.0.11 (bash $BASH_VERSION)"
      status=0
      ;;
